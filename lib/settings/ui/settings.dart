        ...
        return WillPopScope(
          ...
          child: SingleChildScrollView(
            child: Container(
              child: Column(
                children: [
                  SizedBox(height: percentHeight(7)),
                  
                  (_userProfilePic != null)
                    ?ProfilePicture(photoUrl: _userProfilePic,height: percentHeight(21),width: percentWidth(43))
                    :DottedBorder(
                      color: DarkGray,
                      strokeWidth: 3,
                      ...
                      child: Container(
                        constraints: BoxConstraints(maxHeight: percentHeight(22), maxWidth: percentWidth(44)),
                        child: Image.asset(Provider.of<Paths>(context).pathToLogo,
                        excludeFromSemantics: true,
                        fit: BoxFit.contain)),
                    ),
            
                SizedBox(height: percentHeight(3.5)),
                  AutoSizeText('Idealog v1.2',
                    style: AppFontWeight.medium.copyWith(color: Color.fromRGBO(112, 112, 112, 1)),
                    minFontSize: AppFontSize.medium,
                    ),
                    SizedBox(height: percentHeight(7.5)),
