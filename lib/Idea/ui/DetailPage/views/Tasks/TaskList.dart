...
import 'package:idealog/Idea/ui/TaskManager/completedTasksPage.dart';
import 'package:idealog/Idea/ui/TaskManager/highPriorityPage.dart';
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            CompletedTasksWidget(borderRadius: borderRadius, idea: idea)
          ],
        )
      ]
    );
